...
const FormEditUser = () => {
    ...
    useEffect(() => {
      const getUserById = async () => {
        try {
          const response = await axios.get(`https://app-katar.vercel.app/users/${id}`);
    ...
    const updateUser = async (e) => {
      ...
      try {
        await axios.patch(`https://app-katar.vercel.app/users/${id}`, {
          name: name,
          email: email,
          password: password,
    ...
    <div>
        ...
        <div className="card is-shadowless">
            <div className="card-content">
                ...
                <div className="field">
                    <label style={{ color: hslValue}} className="label">Name</label>
                ...
                <div className="field">
                    <div className="control">
                    <button style={{ color: "white" }} type="submit" className="button is-success">Simpan</button>
                    </div>
                </div>
            </form>
                </div>
