...
const DokumentasiAdmin = () => {
    ...
    const deleteDokumentasi = async (dokumentasiId) => {
        try {
            await axios.delete(`https://app-katar.vercel.app/dokumentasi/${dokumentasiId}`);
            getDokumentasi();
        } catch (error) {
                ...
                <tbody>
                    {dokumentasi.map((dokumentasi, index) => (
                        <tr key={dokumentasi.id}>
                            ...
                            <td>
                            <a href={`https://app-katar.vercel.app/uploads/dokumentasi/${dokumentasi.imageKegiatan}`} target="_blank" rel="noopener noreferrer">
