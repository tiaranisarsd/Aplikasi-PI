...
const FormEditDashboard = () => {
    ...
    useEffect(() => {
        const getDashboardById = async () => {
            try {
                const response = await axios.get(`http://194.59.165.159:5000/dashboard/${id}`);
    ...
    const updateDashboard = async (e) => {
        ...
        try {
            ...
            const response = await axios.patch(`http://194.59.165.159:5000/dashboard/${id}`, formData, {
                headers: {
                            ...
                            <div className="field">
                                ...
                                <div className="control">
                                    ...
                                    {imageUrl && typeof imageUrl === 'string' && (
                                        <div style={{ marginBottom: '10px', marginTop: '10px' }}>
                                            <img src={`http://194.59.165.159:5000/uploads/${imageUrl}`} alt={imageUrl} style={{ maxWidth: '200px' }} />
                                            <p>{imageUrl}</p>
                                        </div>
                                    )}
                                </div>
